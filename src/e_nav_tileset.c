...
static E_Nav_Tile_Job * job_add(Evas_Object *obj, int x, int y);
...
job_add(Evas_Object *obj, int x, int y)
{
   E_Smart_Data *sd;
   E_Nav_Tile_Job *job;
   int i, j;
