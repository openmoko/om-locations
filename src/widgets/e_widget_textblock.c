...
EAPI void
e_widget_textblock_move(Evas_Object *obj, int x, int y)
{
   E_Widget_Data *wd;
   wd = e_widget_data_get(obj);
   evas_object_move(wd->o_textblock, x, y);

}

EAPI void
e_widget_textblock_resize(Evas_Object *obj, int w, int h)
{
   E_Widget_Data *wd;
   wd = e_widget_data_get(obj);
...
EAPI void
e_widget_textblock_event_callback_add(Evas_Object *obj, Evas_Callback_Type type, void(*func)(void *data, Evas *e, Evas_Object *obj, void *event_info), const void *data)
{
   E_Widget_Data *wd;
   wd = e_widget_data_get(obj);
   evas_object_event_callback_add(wd->o_textblock, type, func, data);

}

EAPI void
e_widget_textblock_show(Evas_Object *obj)
{
   E_Widget_Data *wd;
   wd = e_widget_data_get(obj);
   evas_object_show(wd->o_textblock);
}
