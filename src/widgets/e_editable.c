...
e_editable_theme_set(Evas_Object *editable, const char *category, const char *group)
{
   ...
   e_nav_theme_object_set(sd->text_object, category, obj_group);
   sd->average_char_w = -1;
   sd->average_char_h = -1;
   ...
   e_nav_theme_object_set(sd->cursor_object, category, obj_group);
   ...
   e_nav_theme_object_set(sd->selection_object, category, obj_group);
